...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    // Supabase fires PASSWORD_RECOVERY once it parses the recovery token from URL hash
      ...
      <div className="w-full max-w-md">
        <div className="mb-10">
          ...
          <p className="text-sm text-gray-500 mt-3">
            {ready
              ? 'Enter and confirm your new password. This becomes your new sign-in password.'
              : 'Waiting for the secure recovery link to load. Open this page from the email link.'}
          </p>
        </div>
